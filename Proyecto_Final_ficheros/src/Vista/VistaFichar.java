...
public class VistaFichar extends javax.swing.JFrame {
    ...
    public VistaFichar(String usuario, String fechaactual, String horaactual, String estado) {
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String estado = e.compruebaentrada(name);
        textestado.setText(estado);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            fechaini = h.menu(name, option, null);
        } catch (ParseException ex) {
            Logger.getLogger(VistaFichar.class.getName()).log(Level.SEVERE, null, ex);
        }
