...
public class Empleado {
    ...
    public Date menu(String user, int idusuario, int opcion, Date fechaIni) throws ParseException {
     ...
     entradas = ConsultaBD4O.obtenusuariofichaentrada(idusuario); //llamamos al metodo que realiza la sentencia
      salidas = ConsultaBD4O.obtenusuariofichasalida(idusuario); //llamamos al metodo que realiza la sentencia
    ...
    public void fichar(int idusuario) {
        ...
        fichajes = ConsultaBD4O.obtenfichajesentrada(); //Devuelve un array con todos los fichajes 
        posicion = fichajes.size() + 1;

        ConsultaBD4O.ficharentrada(idusuario, posicion);
    ...
    public void desfichar(int idusuario) throws ParseException {
        ...
        fichajes = ConsultaBD4O.obtenfichajesalida(); //Devuelve un array con todos los fichajes 
        posicion = fichajes.size() + 1;

        ConsultaBD4O.ficharsalida(idusuario, posicion);

      entradas = ConsultaBD4O.obtenusuariofichaentrada(idusuario); //llamamos al metodo que realiza la sentencia
      salidas = ConsultaBD4O.obtenusuariofichasalida(idusuario); //llamamos al metodo que realiza la sentencia

ConsultaBD4O.horastrabajadashoy(posicion, entradas, salidas);
    ...
    public String compruebaentrada(int iduser) {
        ...
        entradas = ConsultaBD4O.obtenusuariofichaentrada(iduser); //llamamos al metodo que realiza la sentencia
        salidas = ConsultaBD4O.obtenusuariofichasalida(iduser); //llamamos al metodo que realiza la sentencia
